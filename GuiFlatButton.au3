...
Func GuiFlatButton_ButtonHandler($hwnd, $iMsg, $wParam, $lParam, $idx, $pData)
	If $iMsg <> $WM_MOUSEMOVE And $iMsg <> $WM_MOUSELEAVE And $iMsg <> $WM_LBUTTONDBLCLK And $iMsg <> $BM_SETIMAGE Then Return DllCall("comctl32.dll", "lresult", "DefSubclassProc", "hwnd", $hwnd, "uint", $iMsg, "wparam", $wParam, "lparam", $lParam)[0]
